...
const MENU_ITEMS = [
  ...
  // ── עוגות שמרים ──
  {
    ...
    en: { name: 'Chocolate Yeast Cake', desc: 'Homemade yeast cake with chocolate filling' },
    es: { name: 'Bollo de levadura con chocolate', desc: 'Bollo casero relleno de chocolate' },
    price: 8, emoji: '🍫', image: 'images/עוגת שמרים שוקולד.jpeg',
  },
  {
    id: 5, cat: 'yeast',
    name: '2 עוגות שמרים שוקולד', desc: 'שתי עוגות שמרים שוקולד',
    en: { name: '2 Chocolate Yeast Cakes', desc: 'Two chocolate yeast cakes' },
    es: { name: '2 Bollos con chocolate', desc: 'Dos bollos de levadura con chocolate' },
    price: 15, emoji: '🍫', image: 'images/עוגת שמרים שוקולד.jpeg',
  },
  {
    id: 6, cat: 'yeast',
    name: 'עוגת שמרים ריקוטה', desc: 'עוגת שמרים ביתית במילוי ריקוטה',
    en: { name: 'Ricotta Yeast Cake', desc: 'Homemade yeast cake with ricotta filling' },
    es: { name: 'Bollo de levadura con ricota', desc: 'Bollo casero relleno de ricota' },
    price: 9, emoji: '🥐', image: 'images/עוגת שמרים ריקוטה.jpeg',
  },
  {
    id: 7, cat: 'yeast',
    name: '2 עוגות שמרים ריקוטה', desc: 'שתי עוגות שמרים ריקוטה',
    en: { name: '2 Ricotta Yeast Cakes', desc: 'Two ricotta yeast cakes' },
    es: { name: '2 Bollos con ricota', desc: 'Dos bollos de levadura con ricota' },
    price: 17, emoji: '🥐', image: 'images/עוגת שמרים ריקוטה.jpeg',
  },
  {
    id: 8, cat: 'yeast',
    name: 'מעורבב — שוקולד + ריקוטה', desc: 'עוגת שמרים אחת מכל סוג',
    en: { name: 'Mixed — Chocolate + Ricotta', desc: 'One of each type' },
    es: { name: 'Mixto — Chocolate + Ricota', desc: 'Uno de cada tipo' },
  ...
  // ── נשיקות ──
  {
    ...
    en: { name: 'Kisses', desc: 'Kisses pack — 125g' },
    es: { name: 'Besitos', desc: 'Paquete de besitos — 125g' },
    price: 6, emoji: '🍬', image: 'images/נשיקות.jpeg', allWeek: true,
  },
  {
    id: 12, cat: 'kisses',
    name: '2 מארזי נשיקות', desc: 'שני מארזים',
    en: { name: '2 Kisses Packs', desc: 'Two packs' },
    es: { name: '2 paquetes de Besitos', desc: 'Dos paquetes' },
