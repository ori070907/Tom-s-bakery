...
const MENU_ITEMS = [
  ...
  // ── רוגלך ──
  {
    id: 9, cat: 'rugelach',
    name: 'רוגלך',
    desc: 'מארז רוגלך ביתי — 350 גרם',
    price: 6.5, emoji: '🥐', bg: 'linear-gradient(135deg,#F5E0C0,#C8904A)', image: 'images/רוגלעך.jpeg',
  },
  {
    id: 10, cat: 'rugelach',
    name: '2 מארזי רוגלך',
    desc: 'שני מארזי רוגלך — 350 גרם כל אחד',
    price: 11, emoji: '🥐', bg: 'linear-gradient(135deg,#F5E0C0,#C8904A)', image: 'images/רוגלעך.jpeg',
  },
  ...
  // ── עלי גפן ──
  {
    ...
    desc: '10–13 יחידות',
    price: 8, emoji: '🍇', bg: 'linear-gradient(135deg,#D8ECD0,#6A9848)', image: 'images/עלי גפן.jpeg', allWeek: true,
  },

  // ── בלינצ'סים ──
  {
    id: 30, cat: 'blintzes',
    name: "בלינצ'ס פטריות ובצל",
    desc: '5 יחידות',
    price: 10, emoji: '🥞', bg: 'linear-gradient(135deg,#E8D5C4,#A06840)', image: "images/בלינצ'ס פטריות ובצל.jpeg",
  },
  {
    id: 31, cat: 'blintzes',
    name: "בלינצ'ס גבינה מתוקה",
    desc: '5 יחידות',
    price: 10, emoji: '🥞', bg: 'linear-gradient(135deg,#F5E8D8,#D4A896)', image: "images/בלינצ'ס גבינה מתוקה.jpeg",
  },
  ...
  // ── קינוחים ──
  {
    ...
    desc: 'קרמית, עשירה, פירמה — קוטר 18',
  ...
  },
  {
    ...
    price: 27, emoji: '🥮', bg: 'linear-gradient(135deg,#F0E0C8,#C09060)', image: 'images/שבלול פילו.jpeg',
  },

  // ── עוגת שוקולד ──
  {
    id: 28, cat: 'chocolate',
    name: 'עוגת שוקולד פאדג׳ עשירה קוטר 26',
    desc: '',
    price: 40, emoji: '🍫', bg: 'linear-gradient(135deg,#3D1C02,#7A3B10)', image: 'images/עוגת שוקולד.jpeg',
  },
  {
    id: 29, cat: 'chocolate',
    name: 'עוגת שוקולד פאדג׳ עשירה קוטר 20',
    desc: '',
    price: 30, emoji: '🍫', bg: 'linear-gradient(135deg,#3D1C02,#7A3B10)', image: 'images/עוגת שוקולד.jpeg',
  },
...
function renderMenu() {
  document.getElementById('menu-content').innerHTML =
    ...
    `<div class="menu-footer">
       יש בקשה מיוחדת שאינה בתפריט?
       <a href="https://wa.me/972544657263" target="_blank">תפנו אלינו בוואטסאפ 📱</a>
     </div>`;
}
...
function menuCardHTML(item) {
  ...
  if (item.allWeek) {
    ...
    availTag = `<span class="avail-tag fri-shavuot">שישי, שבת, ראשון ושבועות</span>`;
  } else if (item.cat === 'combos') {
    availTag = `<span class="avail-tag fri-shavuot">שישי ושבועות</span>`;
  } else {
